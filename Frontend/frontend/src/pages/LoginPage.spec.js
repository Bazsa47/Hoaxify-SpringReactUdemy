...
describe('LoginPage', () => {
    ...
    describe('interactions',() => {
        ...
        it('sets the username value in state',() => {
            const {queryByPlaceholderText} = render(<LoginPage />);
            const usernameInput = queryByPlaceholderText('Your username');
            fireEvent.change(usernameInput,changeEvent('my-user-name'));
        ...
        it('sets the password value in state',() => {
            const {queryByPlaceholderText} = render(<LoginPage />);
            const passwordInput = queryByPlaceholderText('Your password');
            fireEvent.change(passwordInput,changeEvent('my-password'));
        ...
        it('calls post login when the actions are provided in props and the input fields have value', () => {
            const actions ={
        ...
        it('calls post login with credentials in body', () => {
            const actions ={
                postLogin : jest.fn().mockResolvedValue({})
            }
        ...
        it('enables button when username and password are not empty', () => {
            setupForSubmit();
        ...
        /*it('displays alert when login fails', async() => {
            const actions ={
                postLogin : jest.fn().mockRejectedValue({response:{
                    data:{
        ...
        it('clears error message when user changes username', async() => {
            const actions ={
                postLogin : jest.fn().mockRejectedValue({response:{
                    data:{
                        message:'Login failed'
        ...
        it('clears error message when user changes password', async() => {
            const actions ={
                postLogin : jest.fn().mockRejectedValue({response:{
                    data:{
                        message:'Login failed'
